...
export async function showVideoCallView(parameters, container) {
    ...
    const callButton = iconButton("call-button", [], "/resources/icons/call.svg", call);
    toolbar.appendChild(callButton);
    const cameraButton = iconButton("camera-button", ["off"], "/resources/icons/videocam.svg", toggleCamera);
    toolbar.appendChild(cameraButton);
    const micButton = iconButton("mic-button", ["muted"], "/resources/icons/mic_off.svg", mute);
...
function iconButton(id, classes, icon, callback) {
...
function call() {
    ...
    if (connected)
        img.src = "/resources/icons/call_end.svg";
    else
        img.src = "/resources/icons/call.svg";
...
function mute() {
    ...
    if (muted)
        img.src = "/resources/icons/mic_off.svg";
    else
        img.src = "/resources/icons/mic.svg";
