 ...
 * @author akrck02
 */
export async function setCurrentLanguage(locale, reloadBundles = false) {
    // Set language
    if (undefined === locale) {
 ...
 * @author akrck02
 */
export async function loadTextBundle(id, reload = false, maxAttemps = 1) {
 ...
 * @author akrck02
 */
export function getText(bundleId, textId) {
